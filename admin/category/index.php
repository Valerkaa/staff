                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="add.php" type="button" class="btn btn-block btn-success">+ Add category</a>
                            </div>
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                    <?php foreach (categories($connect) as $category) { ?>
                                    <tr>
                                        <td><?= $category[0] ?></td>
                                        <td><?= $category[1] ?></td>
                                        <td><?= $category['product'] ?></td>
                                        <td><?= date('Y-m-d H:m', strtotime($category[2])) ?></td>
                                        <td><a href="delete.php?id_category=<?= $category[0] ?>" type="button" class="btn btn-block btn-danger">Delete</a></td>
                                    </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
