...
function articles ($connect) {
    $query = sprintf("SELECT * FROM articles WHERE id = ".$_GET['id_articles']);
            ...
            <div class="container-fluid">
                <div class="row d-flex justify-content-center">
                    <div class="col-sm-8 card card-primary">
                        ...
                        <form action="update_post.php" method="POST" id="send" enctype="multipart/form-data" data-bitwarden-watching="1">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Title</label>
                                    <input type="text" class="form-control" value="<?= $articles[0][1] ?>" name="title" id="exampleInputEmail1" placeholder="Title articles">
                                    <input style="display:none;" type="text" class="form-control" value="<?= $articles[0][0] ?>" name="id" id="exampleInputEmail1" placeholder="Title articles">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Preview</label>
                                    <input type="text" class="form-control" name="preview"  value="<?= $articles[0][2] ?>" id="exampleInputEmail1" placeholder="Title articles">
                                </div>
                                <div class="col-md-12">
...
<textarea id="summernote" style="display: none;">                Place &lt;em&gt;some&lt;/em&gt; &lt;u&gt;text&lt;/u&gt; &lt;strong&gt;here&lt;/strong&gt;
                                            ...
                                            <textarea style="display: none" name="text" id="next"><?= htmlspecialchars_decode($articles[0][3]) ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <input type="file" name="fileToUpload" value="<?= $articles[0][4] ?>" class="custom-file-input" id="exampleInputFile">
                                            <label class="custom-file-label" for="exampleInputFile"><?= $articles[0][4] ?></label>
                                        </div>
                                ...
                                <div style="max-width: 200px; display: flex; justify-content: center" class="form-group">
                                    <img style="width: 100%; justify-self: center" src="upload/<?= $articles[0][4] ?>">
                                </div>
                                <div class="form-group">
                                    <label>Category</label>
                                    <select class="form-control" name="category">
                                        <?php  foreach (categoies($connect) as $category) { ?>
                                      <?php  if ($articles[0]['category'] == $category[1]) {?>
...
<script>
    ...
    setTimeout(() =>{
        document.querySelector('[role=textbox').innerHTML = document.getElementById('next').value;
    },1000)
