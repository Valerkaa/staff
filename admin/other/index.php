            ...
            <div class="container-fluid">
                <div class="row d-flex justify-content-center">
                    <div class=" col-sm-6 card card-primary">
                        ...
                        <form action="save.php" method="POST" enctype="multipart/form-data" data-bitwarden-watching="1">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Login</label>
                                    <input type="email" class="form-control" name="login" id="exampleInputEmail1" value="<?= $user['email'] ?>" required placeholder="login">
                                    <input style="display: none" type="hidden" class="form-control" name="id" id="exampleInputEmail1" value="<?= $user['id'] ?>" required placeholder="login">
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Password</label>
                                    <input type="password" class="form-control" name="password" id="exampleInputEmail1" value="<?= $user['password'] ?>" required placeholder="password">
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Phone 1</label>
                                    <input type="text" class="form-control" name="phone_1" id="exampleInputEmail1"   value="<?= $user['phone_1'] ?>"  placeholder="Phone_1">
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Phone 2</label>
                                    <input type="text" class="form-control" name="phone_2" id="exampleInputEmail1" value="<?= $user['phone_2'] ?>"  placeholder="Phone_2">
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Email</label>
                                    <input type="email" class="form-control" name="email_site" id="exampleInputEmail1" value="<?= $user['email_site'] ?>" placeholder="Email">
                                </div>
                            </div>
                            <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputFile">Logo site</label>
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" name="fileToUpload" value="<?= $user['logo'] ?>" class="custom-file-input" id="exampleInputFile">
                                ...
                                <div style="max-width: 200px; display: flex; justify-content: center" class="form-group">
                                    <img style="width: 100%; justify-self: center" src="upload/<?= $user['logo'] ?>">
                                </div>
                            </div>
